<script lang="ts">
    ...
    async function handleLogin(e: Event) {
        ...
        try {
            ...
            errorMessage = error.response?.data?.message || 'Failed to login. Please try again.';
        } finally {
            isLoading = false;
        }
    }
...
<div class="min-h-screen flex items-center justify-center bg-white p-4">
    <div class="w-full max-w-sm space-y-8">
        ...
        <div class="pt-8 space-y-2">
            ...
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Sign In to The App</h1>
        </div>
        ...
        <form class="space-y-6" onsubmit={handleLogin}>
            ...
            <div class="flex items-center space-x-2">
                <Checkbox id="remember" bind:checked={rememberMe} class="border-gray-300 data-[state=checked]:bg-blue-600" />
                <label
                    for="remember"
        ...
        <div class="flex justify-between items-center text-sm pt-8">
            <span class="text-gray-500">Don't have an account? <a href="/signup" class="text-blue-500 hover:underline">Sign up</a></span>
